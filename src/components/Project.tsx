function Project(props: {
  ...
  return (
    <div className="grid md:grid-cols-[0.2fr_3fr] gap-5">
      ...
      <div className="flex flex-col gap-3 text-left">
        ...
        <p className="satoshi-regular">{props.description}</p>
        <div className="mr-auto">
          <div className="flex border-[1px] gap-3 p-2 rounded-md justify-center">
            <img src="/images/robot.svg" alt="" />
            <p className="satoshi-regular">
              {props.type
